...
let mask;
// ABC
const greenIcon = new L.Icon({ //C
    iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/73/Eo_circle_orange_white_letter-c.svg',
    shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
    iconSize: [50, 41],
    iconAnchor: [12, 41],
    popupAnchor: [1, -34],
...
const orangeIcon = new L.Icon({ //B
    iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/a/ab/Eo_circle_yellow_letter-b.svg',
    shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
    iconSize: [25, 41],
    iconAnchor: [12, 41],
    popupAnchor: [1, -34],
...
const redIcon = new L.Icon({
    iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/3/34/Eo_circle_cyan_letter-a.svg',
    shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
    iconSize: [25, 41],
    iconAnchor: [12, 41],
    popupAnchor: [1, -34],
